...
using SqrtDeterminant.Models;

namespace SqrtDeterminant.Controllers
{
    public class HomeController : Controller
    {
        ...
        private static String SqrtMethod(string firstNum, string secondNum) 
        {
            ...
            bool isConvertedNo1 = int.TryParse(firstNum, out firstNumber);
            bool isConvertedNo2 = int.TryParse(secondNum, out secondNumber);
